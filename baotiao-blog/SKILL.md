...
修订文章时一个常见错误: 把跟用户讨论的思考过程写进文章. 读者看不到我们的讨论, 不需要知道 "之前的版本错在哪 / 大家常误解 / 准确的说法是".

要避免的写法:

- "这是常被误解的副作用 / 一个容易混淆的例外"
- "PG 用户常说的 X, 主因一般不是 A 而是 B"
- "准确的说法是 / 严格来说"
- "注意这跟 X 是两回事"
- "也就是说 ..." 后面紧跟一段对前面话的复述纠正

把每一段当成 "第一次写, 写对就行". 如果脑子里有 "之前错在 X, 现在改成 Y" 的过程, 文章里只留 Y 的陈述.

区分清楚:

- 写 "design rationale / why this rule exists" 是合理的, 这是知识
- 写 "这次讨论修订的过程" 不合理, 这是会话记录
